...
Handling). Adjacent to ADR 008 (Schema and Contract Evolution —
forthcoming) on the question of how erased records remain
interpretable across schema versions.
...
* ADR 008 — schema and contract evolution (forthcoming): the question
  of how erased records remain interpretable across schema changes.
